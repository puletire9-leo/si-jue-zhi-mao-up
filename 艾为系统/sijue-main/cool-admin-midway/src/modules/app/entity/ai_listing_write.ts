...
@Entity('app_amz_ai_listing_write')
export class AppAmzAiListingWriteEntity extends BaseEntity {
  ...
  @Column({comment:'需求国家', type: 'json', nullable: true })
  marketplaceNeeds: string[];
