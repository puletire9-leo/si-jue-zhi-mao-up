 ...
 */
@Entity('app_amz_bsr_replenish_volatility_coefficient')
@Index('idx_replenish_volatility_listing', ['listing_id'])
@Index(
    'uk_replenish_volatility_product',
    ['product_code', 'marketplace', 'asin', 'msku', 'store_id'],
    { unique: true }
)
export class AppAmzBsrReplenishVolatilityCoefficientEntity extends BaseEntity {
    ...
    @Column({ comment: '波动系数', type: 'decimal', precision: 10, scale: 2, default: 0.75 })
