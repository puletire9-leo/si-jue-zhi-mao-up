<template>
	<cl-crud ref="Crud">
		...
		<cl-upsert ref="Upsert">
		  ...
		  <el-button type="info" @click="handleGenerateLocalSKU(scope)" :loading="generatingSKU">
			生成本地SKU
		  </el-button> -->
					...
					>
						<div class="country-group">
							...
							<div class="chart-container">
								<div
									:id="'sales-chart-' + countryCodeMap[country]"
									class="compact-chart"
							...
							<div class="chart-container">
								<div
									:id="'keyword-chart-' + countryCodeMap[country]"
									class="compact-chart"
									style="width: 100%; height: 180px"
								></div>
							</div>
...
import BsrCandidateCompetitorComponent from "/$/app/components/bsr-candidate-competitor-component_customize.vue";
...
const Crud = useCrud(
	{
		service: service.app.bsr_candidate_customize,
...
const Table = useTable({
	columns: [
		...
		//   { label: '产品标题', prop: 'item_name', showOverflowTooltip: true, minWidth: 100, fixed: 'left' },
		{
			label: "产品名称",
			prop: "produce_name",
...
async function calculate() {
	...
	try {
		...
		const response = await service.app.bsr_candidate_competitor_customize.page({
...
function swapMainImage(row: any, clickedField: string) {
	...
	service.app.bsr_candidate_customize.update(row);
}
