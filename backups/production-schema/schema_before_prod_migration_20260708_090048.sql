...
--
-- Table structure for table `_images_old`
--

DROP TABLE IF EXISTS `_images_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_images_old` (
  ...
  `cos_object_key` varchar(500) DEFAULT NULL,
  `cos_url` varchar(500) DEFAULT NULL,
  `cos_thumbnail_key` varchar(500) DEFAULT NULL,
  `cos_thumbnail_url` varchar(500) DEFAULT NULL,
  `original_zip_filepath` varchar(500) DEFAULT NULL,
  `original_zip_cos_key` varchar(500) DEFAULT NULL,
  `sku` varchar(100) DEFAULT '',
  `original_file_size` bigint DEFAULT '0',
  `original_format` varchar(50) DEFAULT '',
  ...
  `thumbnail_cos_key` varchar(512) DEFAULT '',
  `thumbnail_cos_url` varchar(1024) DEFAULT '',
  `thumbnail_local_path` varchar(512) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `agg_ad_performance`
--

DROP TABLE IF EXISTS `agg_ad_performance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `agg_category_rank`
--

DROP TABLE IF EXISTS `agg_category_rank`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `agg_daily_stats`
--

DROP TABLE IF EXISTS `agg_daily_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `agg_monthly_stats`
--

DROP TABLE IF EXISTS `agg_monthly_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `analysis_batches`
--
...
--
-- Table structure for table `asin_import_results`
--

DROP TABLE IF EXISTS `asin_import_results`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4956164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `asin_import_tasks`
--

DROP TABLE IF EXISTS `asin_import_tasks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asin_import_tasks` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `marketplace` varchar(10) DEFAULT NULL,
  `import_type` varchar(50) DEFAULT 'ASIN',
...
--
-- Table structure for table `blue_ocean_scan_results`
--

DROP TABLE IF EXISTS `blue_ocean_scan_results`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blue_ocean_scan_results` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `marketplace` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UK' COMMENT '站点（UK/DE）',
  `month` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据月份（如 202605）',
  `category` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类名称',
  `opportunity_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '机会类型',
  `blue_ocean_score` decimal(8,2) DEFAULT NULL COMMENT '蓝海机会评分',
  `radar_json` text COLLATE utf8mb4_unicode_ci COMMENT '雷达图JSON',
  `recommendations_json` text COLLATE utf8mb4_unicode_ci COMMENT '推荐策略JSON',
...
--
-- Table structure for table `carrier_library`
--

DROP TABLE IF EXISTS `carrier_library`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `carrier_library_recycle_bin`
--

DROP TABLE IF EXISTS `carrier_library_recycle_bin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `category_age_tier_baseline`
--

DROP TABLE IF EXISTS `category_age_tier_baseline`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='M04 æ–°å“å¤§ç±»Ã—è´¦é¾„Ã—é”€é‡åˆ†çº§åŸºçº¿';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `category_baselines`
--

DROP TABLE IF EXISTS `category_baselines`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `category_baselines` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `marketplace` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UK' COMMENT '站点',
  `category_label` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类标签',
  `archetype` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类原型（DA/FH/FP/TN/PE/PS）',
  `sample_size` int DEFAULT '0' COMMENT '样本量',
  `baseline_month` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '基线月份',
  ...
  `data_source` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '数据来源',
...
--
-- Table structure for table `category_bsr_baseline`
--

DROP TABLE IF EXISTS `category_bsr_baseline`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `category_bsr_baseline` (
  ...
  KEY `idx_lookup` (`marketplace`,`bsr_id`,`baseline_month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Line1 category BSR baseline';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `category_dislocation`
--

DROP TABLE IF EXISTS `category_dislocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Line2 subcategory dislocation signal';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `category_heat_matrix`
--

DROP TABLE IF EXISTS `category_heat_matrix`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `category_heat_matrix` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `marketplace` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UK' COMMENT '站点',
  `month` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据月份',
  `category` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类名称',
  ...
  `heat_signal` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '热度信号',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_marketplace_month` (`marketplace`,`month`),
  KEY `idx_category` (`category`(64)),
...
--
-- Table structure for table `category_tree_node`
--
...
CREATE TABLE `category_tree_node` (
  ...
  `marketplace` varchar(10) NOT NULL COMMENT '?? UK/DE/US',
  `level` int NOT NULL COMMENT '?? 1=??',
  `label` varchar(200) NOT NULL COMMENT '?????',
  `label_path` varchar(500) NOT NULL COMMENT '?????????????(:??)',
  `parent_label_path` varchar(500) DEFAULT NULL COMMENT '??? label_path???? NULL',
  `node_id` varchar(32) DEFAULT NULL COMMENT '?????ID(????)',
  `bsr_id` varchar(32) DEFAULT NULL COMMENT '??????? level=1 ??',
  `product_count` int NOT NULL DEFAULT '0' COMMENT '??ASIN?(???)',
  `direct_count` int NOT NULL DEFAULT '0' COMMENT '?????ASIN?',
  `batch_date` varchar(20) DEFAULT NULL COMMENT '????(?????)',
...
--
-- Table structure for table `competitor_lookup_log`
--

DROP TABLE IF EXISTS `competitor_lookup_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `competitor_lookup_log` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6270 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `competitor_products` (
  ...
  `sales_tier` varchar(16) NOT NULL DEFAULT 'UNKNOWN' COMMENT 'Base feature: sales volume tier A/B/C/D/UNKNOWN',
  ...
  `m01_active` tinyint NOT NULL DEFAULT '0' COMMENT 'M01 active hit flag: 1=current qualified new product, 0=not active',
  `m04_age_bucket` varchar(16) DEFAULT NULL COMMENT 'M04 æ–°å“è´¦é¾„æ¡£ / out_of_scope',
  `m04_tier` varchar(16) DEFAULT NULL COMMENT 'M04 ç­‰çº§ S/A/B/C/D / out_of_scope',
  ...
  KEY `idx_m01_active_seller` (`marketplace`,`m01_active`,`seller_name`),
  KEY `idx_m01_active_avail` (`m01_active`,`available_date`)
) ENGINE=InnoDB AUTO_INCREMENT=528987 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `competitor_products_clean`
--
...
CREATE TABLE `competitor_products_clean` (
  ...
  `week_tag` varchar(10) DEFAULT NULL COMMENT 'ISOå‘¨æ ‡è®°',
  `is_current` int DEFAULT '0' COMMENT 'æ˜¯å¦æœ¬å‘¨',
  `m01_active` tinyint NOT NULL DEFAULT '0' COMMENT 'M01 active hit flag copied by parent group',
  `dedup_key` varchar(20) NOT NULL COMMENT 'COALESCE(parent_asin, asin)',
  `effective_week_tag` varchar(10) NOT NULL COMMENT 'æ¸…æ´—ç”¨ week_tagï¼›è€æ•°æ®ç”¨ month-W00 å ä½',
  `cleaned_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `m04_age_bucket` varchar(16) DEFAULT NULL,
  `m04_tier` varchar(16) DEFAULT NULL,
  ...
  KEY `idx_m01_active_seller_clean` (`marketplace`,`m01_active`,`seller_name`),
  KEY `idx_m01_active_avail_clean` (`m01_active`,`available_date`)
) ENGINE=InnoDB AUTO_INCREMENT=528987 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `competitor_subcategories`
--

DROP TABLE IF EXISTS `competitor_subcategories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=306117 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `deng_zong_shop`
--

DROP TABLE IF EXISTS `deng_zong_shop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `deng_zong_shop` (
  ...
  `batch_date` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `deng_zong_shop_seller`
--

DROP TABLE IF EXISTS `deng_zong_shop_seller`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `download_task_files`
--

DROP TABLE IF EXISTS `download_task_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `download_tasks` (
  ...
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `request_data` text COLLATE utf8mb4_unicode_ci COMMENT 'JSON serialized file list for retry',
...
--
-- Table structure for table `final_draft_recycle_bin`
--

DROP TABLE IF EXISTS `final_draft_recycle_bin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `final_draft_recycle_bin` (
  ...
  KEY `idx_sku` (`sku`),
  KEY `idx_delete_time` (`delete_time`)
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定稿回收站表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `final_drafts`
--

DROP TABLE IF EXISTS `final_drafts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2206 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定稿信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `follow_signals`
--

DROP TABLE IF EXISTS `follow_signals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `follow_signals` (
  ...
  `month` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据月份',
  `category` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类名称',
  `first_seller` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首发卖家',
  `first_asin` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首发ASIN',
  ...
  `signal_strength` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '信号强度',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_marketplace_month` (`marketplace`,`month`),
  KEY `idx_category` (`category`(64)),
...
--
-- Table structure for table `image_access_logs`
--
...
--
-- Table structure for table `image_encoding_records`
--

DROP TABLE IF EXISTS `image_encoding_records`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `image_operation_logs`
--

DROP TABLE IF EXISTS `image_operation_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3997 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='图片表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lingxing_local_product`
--

DROP TABLE IF EXISTS `lingxing_local_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lingxing_local_product` (
  `id` bigint NOT NULL COMMENT '????????',
  `lingxing_id` bigint NOT NULL COMMENT '?????? ID???????',
  `sku` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '???? SKU',
  `sku_identifier` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SKU ???',
  `product_name` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??',
  `cid` bigint DEFAULT NULL COMMENT '?? ID',
  `category_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `bid` bigint DEFAULT NULL COMMENT '?? ID',
  `brand_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `pic_url` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `ps_id` bigint DEFAULT NULL COMMENT 'SPU ?? ID',
  `spu` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SPU',
  `cg_price` decimal(18,4) DEFAULT NULL COMMENT '?????????',
  `cg_delivery` int DEFAULT NULL COMMENT '???????',
  `cg_transport_costs` decimal(18,4) DEFAULT NULL COMMENT '??????',
  `purchase_remark` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `status` tinyint DEFAULT NULL COMMENT '???0-?? 1-?? 2-??? 3-??',
  `status_text` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `open_status` tinyint DEFAULT NULL COMMENT '?????0-?? 1-??',
  `is_combo` tinyint DEFAULT NULL COMMENT '???????0-? 1-?',
  `product_developer_uid` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '???? ID',
  `product_developer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??????',
  `cg_opt_uid` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??? ID',
  `cg_opt_username` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?????',
  `lx_create_time` datetime DEFAULT NULL COMMENT '??????',
  `lx_update_time` datetime DEFAULT NULL COMMENT '??????',
  `raw_json` json DEFAULT NULL COMMENT '?????????',
  `synced_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '????????',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_lingxing_id` (`lingxing_id`),
  KEY `idx_sku` (`sku`),
  KEY `idx_status` (`status`),
  KEY `idx_lx_update_time` (`lx_update_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='???????productList/productInfo ??????';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lingxing_product_performance`
--

DROP TABLE IF EXISTS `lingxing_product_performance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lingxing_product_performance` (
  `id` bigint NOT NULL COMMENT '????????',
  `biz_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '????? summaryField:value|sidScope|start|end|currency',
  `summary_field` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?????asin/parent_asin/msku/sku',
  `summary_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?????',
  `sid_scope` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??????????????',
  `asin` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ASIN',
  `parent_asin` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '? ASIN',
  `msku` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'MSKU',
  `sku` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?? SKU',
  `item_name` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??',
  `currency_code` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `start_date` date DEFAULT NULL COMMENT '?????-??',
  `end_date` date DEFAULT NULL COMMENT '?????-??',
  `volume` int DEFAULT NULL COMMENT '??',
  `order_items` int DEFAULT NULL COMMENT '???',
  `amount` decimal(18,4) DEFAULT NULL COMMENT '???',
  `gross_profit` decimal(18,4) DEFAULT NULL COMMENT '?????',
  `gross_margin` decimal(18,6) DEFAULT NULL COMMENT '?????',
  `sessions_total` int DEFAULT NULL COMMENT 'Sessions-Total',
  `spend` decimal(18,4) DEFAULT NULL COMMENT '????',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='???????asinList ??????';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lingxing_profit_asin`
--

DROP TABLE IF EXISTS `lingxing_profit_asin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lingxing_profit_asin` (
  `id` bigint NOT NULL COMMENT '????????',
  `biz_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '????? asin|sid|dataDate|currency',
  `asin` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ASIN',
  `parent_asin` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '? ASIN',
  `sid` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?? ID',
  `store_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '???',
  `data_date` date DEFAULT NULL COMMENT '??????????',
  `country_code` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????',
  `local_sku` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SKU',
  `local_name` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??',
  `item_name` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??',
  `currency_code` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??',
  `total_sales_quantity` int DEFAULT NULL COMMENT '??',
  `total_sales_amount` decimal(18,4) DEFAULT NULL COMMENT '???',
  `total_ads_cost` decimal(18,4) DEFAULT NULL COMMENT '???',
  `cg_price` decimal(18,4) DEFAULT NULL COMMENT '????',
  `cg_transport_costs` decimal(18,4) DEFAULT NULL COMMENT '????',
  `total_cost` decimal(18,4) DEFAULT NULL COMMENT '????',
  `gross_profit` decimal(18,4) DEFAULT NULL COMMENT '???',
  `gross_rate` decimal(18,6) DEFAULT NULL COMMENT '???',
  `raw_json` json DEFAULT NULL COMMENT '?????????',
  `synced_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '????????',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_biz_key` (`biz_key`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='??????-ASIN?????????';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lingxing_seller`
--

DROP TABLE IF EXISTS `lingxing_seller`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lingxing_seller` (
  `id` bigint NOT NULL COMMENT '????????',
  `sid` bigint NOT NULL COMMENT '???? ID???????',
  `mid` bigint DEFAULT NULL COMMENT '?? ID',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '???',
  `seller_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????? ID',
  `account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '??????',
  `seller_account_id` bigint DEFAULT NULL COMMENT '???? ID',
  `region` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?????? NA ????',
  `country` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '????????',
  `has_ads_setting` tinyint DEFAULT NULL COMMENT '???????0-? 1-?',
  `marketplace_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '?? ID',
  `status` tinyint DEFAULT NULL COMMENT '?????0-???? 1-?? 2-???? 3-????',
  `raw_json` json DEFAULT NULL COMMENT '?????????',
  `synced_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '????????',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='????????seller/lists ???sid ???';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `material_library_recycle_bin`
--

DROP TABLE IF EXISTS `material_library_recycle_bin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `person_roster`
--

DROP TABLE IF EXISTS `person_roster`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_roster` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='人员名单（按职能）';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `product_30day_new`
--

DROP TABLE IF EXISTS `product_30day_new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_30day_new` (
  ...
  KEY `idx_asin` (`asin`),
  KEY `idx_listing_days` (`listing_days`)
) ENGINE=InnoDB AUTO_INCREMENT=85777 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `product_click_log`
--

DROP TABLE IF EXISTS `product_click_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_click_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'username',
  `asin` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品ASIN',
  `marketplace` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '站点 UK/DE',
  `source` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '新品榜' COMMENT '来源: 新品榜/竞品店铺/总选品',
  `action` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '行为类型: click=浏览卡片/跳链接, select=选中',
  `product_title` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品标题(冗余，分析时免JOIN)',
...
) ENGINE=InnoDB AUTO_INCREMENT=419 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='产品点击行为记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `product_line_elements`
--

DROP TABLE IF EXISTS `product_line_elements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `product_operation_logs`
--
...
--
-- Table structure for table `product_performance_actual`
--

DROP TABLE IF EXISTS `product_performance_actual`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_performance_actual` (
  `id` bigint NOT NULL COMMENT 'é›ªèŠ±ID',
  `asin` varchar(20) NOT NULL COMMENT 'ASIN',
  `parent_asin` varchar(20) DEFAULT NULL COMMENT 'çˆ¶ASIN',
  `sku` varchar(100) DEFAULT NULL COMMENT 'SKU',
  `marketplace` varchar(10) NOT NULL COMMENT 'ç«™ç‚¹: UK/DE/IT/US',
  `price` decimal(10,2) DEFAULT NULL COMMENT 'å”®ä»·(æ¸…æ´—è´§å¸ç¬¦å·)',
  `sales_volume` int DEFAULT NULL COMMENT 'é”€é‡',
  `category_rank_main` varchar(200) DEFAULT NULL COMMENT 'å¤§ç±»æŽ’ååŽŸæ–‡',
  `category_main` varchar(100) DEFAULT NULL COMMENT 'å¤§ç±»å',
  `category_rank_sub` varchar(200) DEFAULT NULL COMMENT 'å°ç±»æŽ’ååŽŸæ–‡',
  `category_sub` varchar(150) DEFAULT NULL COMMENT 'å°ç±»å',
  `acoas` decimal(8,4) DEFAULT NULL COMMENT 'å¹¿å‘Šé”€å”®æˆæœ¬å æ¯”',
  `natural_clicks` int DEFAULT NULL COMMENT 'è‡ªç„¶ç‚¹å‡»é‡',
  `ctr` decimal(6,4) DEFAULT NULL COMMENT 'CTR ç™¾åˆ†æ¯”è½¬å°æ•°',
  `ad_cvr` decimal(6,4) DEFAULT NULL COMMENT 'å¹¿å‘Š CVR ç™¾åˆ†æ¯”è½¬å°æ•°',
  `natural_orders` int DEFAULT NULL COMMENT 'è‡ªç„¶è®¢å•é‡',
  `fba_available` int DEFAULT NULL COMMENT 'FBA å¯å”®',
  `refund_rate` decimal(6,4) DEFAULT NULL COMMENT 'é€€æ¬¾çŽ‡ ç™¾åˆ†æ¯”è½¬å°æ•°',
  `product_name` varchar(500) DEFAULT NULL COMMENT 'ä¸­æ–‡å“å',
  `title` varchar(1000) DEFAULT NULL COMMENT 'è‹±æ–‡æ ‡é¢˜',
  `archetype` varchar(8) DEFAULT NULL COMMENT 'åŽŸåž‹: STD/CUSTOM',
  `element` varchar(100) DEFAULT NULL COMMENT 'å…ƒç´ ',
  `carrier` varchar(100) DEFAULT NULL COMMENT 'è½½ä½“',
  `listing_tags` varchar(200) DEFAULT NULL COMMENT 'åŽŸå§‹æ ‡ç­¾',
  `is_eliminated` tinyint DEFAULT '0' COMMENT 'æ ‡ç­¾å«æ·˜æ±°',
  `is_green` tinyint DEFAULT '0' COMMENT 'æ ‡ç­¾å«ç»¿æ ‡',
  `bsr_id` varchar(100) DEFAULT NULL COMMENT 'å¤§ç±» slug',
  `source_batch` varchar(50) DEFAULT NULL COMMENT 'å¯¼å…¥æ‰¹æ¬¡',
  `imported_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'å¯¼å…¥æ—¶é—´',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='è‡ªæœ‰çœŸå®žæˆ˜ç»©(tier1çœŸå€¼,591èµ¢å®¶)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products_backup` (
  ...
  `create_time` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `product_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `developer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `image_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `local_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `thumb_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`sku`),
  KEY `idx_products_sku` (`sku`) USING BTREE,
  KEY `idx_products_name` (`name`(100)) USING BTREE,
  KEY `idx_products_type` (`product_type`) USING BTREE,
  KEY `idx_products_search` (`sku`,`name`,`product_type`) USING BTREE,
  KEY `idx_products_full` (`sku`,`name`,`product_type`,`developer`,`create_time`) USING BTREE,
  FULLTEXT KEY `idx_fulltext_name` (`name`) /*!50100 WITH PARSER `ngram` */
...
--
-- Table structure for table `reference_data_versions`
--

DROP TABLE IF EXISTS `reference_data_versions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `selection_decisions`
--

DROP TABLE IF EXISTS `selection_decisions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `selection_decisions` (
  ...
  `decision_month` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '决策月份',
  `category_label` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类标签',
  `category_prototype` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类原型',
  `selection_score` int DEFAULT '0' COMMENT '选品综合评分（0-100）',
  `selection_grade` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '选品等级（S/A/B/C/D）',
  ...
  `decision_status` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '决策状态（SELECT/PASS/PENDING）',
  `signal_boosts` text COLLATE utf8mb4_unicode_ci COMMENT '信号加成JSON',
  ...
  `verify_month` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '验证月份',
  ...
  `outcome` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '验证结果（SUCCESS/NEUTRAL/FAIL/PENDING）',
  `outcome_detail` text COLLATE utf8mb4_unicode_ci COMMENT '验证详情JSON',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `verified_at` datetime DEFAULT NULL COMMENT '验证时间',
  `verified_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '验证人',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `selection_new_products`
--

DROP TABLE IF EXISTS `selection_new_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `selection_operation_logs`
--

DROP TABLE IF EXISTS `selection_operation_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `selection_recycle_bin`
--

DROP TABLE IF EXISTS `selection_recycle_bin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `selection_reference_products`
--

DROP TABLE IF EXISTS `selection_reference_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `selection_stats`
--
...
CREATE TABLE `seller_profiles` (
  ...
  `marketplace` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UK' COMMENT '站点',
  `month` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据月份',
  `seller_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '卖家名称',
  ...
  `grade` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评级别（S/A/B/C/D）',
  `archetype` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '擅长品类原型',
  ...
  `category_focus` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '主营品类',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_marketplace_month` (`marketplace`,`month`),
...
) ENGINE=InnoDB AUTO_INCREMENT=158897 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `skip_asins`
--

DROP TABLE IF EXISTS `skip_asins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `skip_asins` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_asin_marketplace` (`asin`,`marketplace`)
) ENGINE=InnoDB AUTO_INCREMENT=3442123 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `subcategory_alias_map`
--

DROP TABLE IF EXISTS `subcategory_alias_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `subcategory_alias_map` (
  ...
  `carrier_hint` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Carrier hint from â‘¢ line',
...
--
-- Table structure for table `subcategory_baseline`
--

DROP TABLE IF EXISTS `subcategory_baseline`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Line1 Amazon leaf subcategory baseline (marketplace x bsr_id x leaf x month)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_config` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `config_key` (`config_key`)
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `system_docs`
--
...
--
-- Table structure for table `user_filter_presets`
--
...
--
-- Table structure for table `users_bak_20260630`
--

DROP TABLE IF EXISTS `users_bak_20260630`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_bak_20260630` (
  ...
  `full_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '全名',
  `role` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'user' COMMENT '角色（admin:管理员, editor:编辑, user:普通用户）',
  `developer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '关联开发人',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态（0:禁用, 1:启用）',
  `last_login_time` datetime DEFAULT NULL COMMENT '最后登录时间',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
...
--
-- Table structure for table `users_bak_20260630_op`
--

DROP TABLE IF EXISTS `users_bak_20260630_op`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_bak_20260630_op` (
  `id` int NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '密码（加密）',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '邮箱',
...
-- Dump completed on 2026-07-08  1:00:49
