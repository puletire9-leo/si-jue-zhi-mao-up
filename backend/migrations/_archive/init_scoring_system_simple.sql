...
-- 3. 插入默认评分维度配置
INSERT IGNORE INTO scoring_config (dimension_key, display_name, weight, thresholds) VALUES
...
-- 4. 插入默认等级阈值
INSERT IGNORE INTO grade_thresholds (grade, min_score, max_score, color) VALUES
('S', 90, 100, '#67C23A'),
('A', 80, 89, '#409EFF'),
('B', 65, 79, '#E6A23C'),
('C', 50, 64, '#909399'),
